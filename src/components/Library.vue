      ...
      nouns: [
        {
          ...
          info: 'Dave recieved his scarab for saving his village from a giant toad attack.',
          tags: ['PC', 'Barbarian', 'Goliath', 'Land of the Small', 'Burrowburgh', 'Ruby Basilisk'],
        ...
        },
        {
          ...
          subtitle: 'Aasimar Monk, Isla Relampago',
          avatar: 'https://www.dndbeyond.com/avatars/17/965/636378921768973657.jpeg',
          text: 'A lightly tan skinned Aasimar with three pairs of serafim-like wings.',
          info: 'Chipp recieved her scarab when she sneezed real hard.',
        ...
        },
        {
          ...
          info: 'Dahlen is a shy fellow, but deeply curious about his surroundings. Dahlen has largely existed in the shadow of his (pureblood) elven grandfather, who raised him. Dahlen is not very well traveled, and has never left the comfort of his home-forest prior to this adventure. Dahlen recieved his scarab when he found a thing and accidentally killed a guy. I wasn\'t supposed to say that.\n\n"Elmon delmon. Teamwork makes the dream work!"',
        ...
        },
        {
          ...
          text: 'With a jaw approved by the CW, Dashiel is as handosme as they come. Brown hair, brown eyes, paler skin with a slight tan, 6\'4" tall, lean, swimmers build. Dahsiel is wearing a dark gray tunic, a red scarf, and drapery around his waist.',
          info: 'Dashiel recieved his scarab after completing an amazing performance.',
        ...
        },
        {
          ...
          text: 'A small fairy who very recently arirved from the Feywild.',
          info: 'Roughly 3 feet tall, 30-35 lbs, with 90s JRPG spikey red hair. Wearing chainmail and donning a shield. Selmenoch dresses primarily in autumn colors like gold, brass, and orange with purple accents. His shield is decorated with a paw, crossed witha lance. He rides atop a larger than average corgi named Cosmo.\n\nSelmenoch is a well trained dragoon who served in the first batallion calvary under the leadership of Lady Ophelia Cogwin. He was part of the Corgi Batallion!',
        ...
        },
        {
          ...
          text: 'Dave\'s hometown. Once attacked by a giant toad. Population mostly consists of halfings, gnomes, fairies, and grung.',
          info: null,
        ...
        },
        {
          ...
          avatar: '../pepper.png',
          text: 'An employee abaord the Darning Needle, and assistant to the train\'s owner, Mr. Toggins.',
          info: 'Pepper has strong, almost masculine features. Her skin is a pale gray, with a stone-like edifice to it containing sprakly freckles. Her unfirm consists of a blue/gray pair of slacks, a white ruffled shirt, and a jacket that matches her pants. Dark charcoal hair pulled back into a bun of thick dreadlocks.',
        ...
        },
        {
          ...
          info: '"I find the lack of trees...     upsettng."',
        ...
        },
        {
          ...
          avatar: '../patron.png',
          text: 'Summoned Dahlin and 19 others to a shared dream where she said "You\'ve all earned a fraction of my power, I\'m looking for 5 that deserve all of my power. Be bold mortals. Be adventurous, be ruthless. I\'ll be watching. You don\'t want to be one of the losers."',
