    ...
    data: () => ({
      ...
      nouns: [
        ...
        },
        {
          ...
          info: 'Dahlen is a shy fellow, but deeply curious about his surroundings. He has largely existed in the shadow of his (pureblood) elven grandfather, who raised him. Dahlen is not very well traveled, and has never left the comfort of his home-forest prior to this adventure. He recieved his scarab when he found a thing and accidentally killed a guy. I wasn\'t supposed to say that.\n\n"Elmon delmon. Teamwork makes the dream work!"',
        ...
        },
        {
          ...
          info: 'Pepper has strong, almost masculine features. Her skin is a pale gray, with a stone-like edifice to it containing sprakly freckles. Her unifirm consists of a blue/gray pair of slacks, a white ruffled shirt, and a jacket that matches her pants. Dark charcoal hair pulled back into a bun of thick dreadlocks.',
