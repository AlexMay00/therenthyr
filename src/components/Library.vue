    ...
    data: () => ({
      ...
      nouns: [
        ...
        },
        {
          ...
          subtitle: 'A forest in southern Valen',
        ...
        },
        {
          ...
          text: 'This bunnies-riding-chickens summoning man stole Dovin\'s tears from the Darning Needle. Gold level aura.',
          info: null,
          tags: ['NPC', 'Villain'],
        ...
        },
        {
          ...
          subtitle: 'Elf, ???',
          avatar: '../aunt.jpg',
          text: 'Offensive magic teacher at Almiraj, and Aaron\'s aunt. She forced Aaron to destroy a dungeon crystal on his own, and Aaron thought that was preferable to dealing with her.',
