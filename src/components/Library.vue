    ...
    data: () => ({
      ...
      nouns: [
        ...
        },
        {
          ...
          associations: ['Dragonborn', 'Dragons'],
          icon: 'mdi-city',
          type: 'location',
          subtype: 'city',
          order: 30
        ...
        },
        {
          ...
          text: '',
          info: '',
          tags: ['Hamburg', 'Capital', 'City', 'Farmland'],
          associations: ['Colonized'],
          icon: 'mdi-city',
          type: 'location',
          subtype: 'city',
        ...
        },
        {
          ...
          info: '',
          tags: ['Farmland'],
          associations: ['Colonized', 'Mountains', 'Land bridge'],
          icon: 'mdi-earth',
          type: 'location',
          subtype: 'nation',
          order: 131
        ...
        },
        {
          ...
          text: 'Skinks are lizards belonging to the family Scincidae, a family in the infraorder Scincomorpha. With more than 1,500 described species across 100 different taxonomic genera, the family Scincidae is one of the most diverse families of lizards.',
          info: 'While most skinks are harmless to humans and other animals, it\'s essential to remember that there may be exceptions, and some species could carry diseases or parasites. Therefore, it\'s generally advisable to handle any wild animal, including skinks, with caution and avoid unnecessary contact.',
          tags: ['PC', 'Druid', 'Lizardfolk'],
          associations: ['Faction Agent'],
          icon: 'mdi-account',
          type: 'character',
          subtype: 'pc',
          order: 510
